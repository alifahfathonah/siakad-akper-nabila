                            ...
                            <section class="content">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <a class="btn btn-sm btn-primary" href="<?= site_url('Ruangan_A/add') ?>">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table class="table table-sm table-striped table-bordered" id="ruangan">
                                                            <thead align="center">
                                                                <tr>
                                                                    
                                                                <th><font  color="#000000" text-align="left">No </th>
                                                                <th><font  color="#000000">Kode Ruangan </th>
                                                              
                                                                <th><font  color="#000000">Kapasitas </th>
                                                                <th><font  color="#000000">Jenis Ruangan </th>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr align="center">
                                                                    ...
                                                                    <td>
                                                                        <a href="<?= site_url('Ruangan_A/edit/' . $row['idruangan']) ?>">
										                                <button type="button"  class="btn btn-primary btn-circle btn-sm btn-edit">
                                                                            <i class="fa fa-edit"></i>
                                                                        </button>
                                                                        </a>

                                                                        <a href="javascript:void(0)" onclick="hapus('<?= $row['idruangan'] ?>')">
...
<div class="modal fade" id="hapusruangan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="<?php echo site_url('Ruangan_A/delete') ?>">
