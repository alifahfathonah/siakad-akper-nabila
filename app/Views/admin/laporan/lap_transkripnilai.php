                    ...
                    <table style="border-collapse: collapse; width: 90%;" border="0">
                        ...
                        <tr>
                            <td style="text-align: left;">
                                <span span style="font-size: 12pt; font-weight: bold;">Nama : <?= $mahasiswa->nama; ?>
                                </span>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: left;">
                                <span span style="font-size: 12pt; font-weight: bold;">Nim : <?= $mahasiswa->nim; ?>
                                </span>
                            </td>
                        </tr>
                        ...
                        <table style="border-collapse: collapse; width: 90%;" border="1">
                            <thead>
                                ...
                                foreach (matakuliah($smt) as $row) : $no++;
                                    ...
                                    $qry = $db->query("SELECT*FROM `tb_nilai` JOIN users ON `nimnilai`=username WHERE nimnilai='$mahasiswa->nim' AND kodematkulnilai='$kodematkul';");
                            ...
                            <tr>
                                ...
                                <td width="74%" align="center">
                                    <table width="80%">
                                        ...
                                        <tr>
                                            <td>
                                                <div style="border-width: 1px;border-color: black;border-style: dotted;width:3.2cm;height:4.2cm;display:flex;justify-content: center;align-items: center;">
                                                    Foto 3x4
                                                </div>
                                            </td>
                                        </tr>
