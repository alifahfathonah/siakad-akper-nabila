                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                ...
                                                <a class="nav-link h5 mb-0 font-weight-bold text-danger" href="<?= site_url('C_Home/menudosen') ?>">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                               ...
                                               <a class="nav-link h5 mb-0 font-weight-bold text-warning" href="<?= site_url('C_Data_Kampus/datakampusdosen') ?>">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                ...
                                                <a class="nav-link h5 mb-0 font-weight-bold text-success" href="<?= site_url('C_Nilai/tampilnilai') ?>">
                                                <div class="h6 mb-0 font-weight-bold text-success">Input Nilai</div>
                                                </a>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                ...
                                                <a class="nav-link h5 mb-0 font-weight-bold text-dark" href="<?= site_url('Master_Dosen/profile') ?>">
